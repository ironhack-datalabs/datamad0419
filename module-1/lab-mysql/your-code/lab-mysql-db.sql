...
CREATE TABLE IF NOT EXISTS `lab-mysql-db`.`Cars` (
  ...
  CONSTRAINT `fk_Cars_Invoices1`
    ...
    REFERENCES `lab-mysql-db`.`Invoices` (`idInvoices`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `lab-mysql-db`.`Salesperson_has_Customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab-mysql-db`.`Salesperson_has_Customers` (
  `Salesperson_idSalesperson` INT NOT NULL,
  `Customers_idCustomers` INT NOT NULL,
  PRIMARY KEY (`Salesperson_idSalesperson`, `Customers_idCustomers`),
  INDEX `fk_Salesperson_has_Customers_Customers1_idx` (`Customers_idCustomers` ASC) VISIBLE,

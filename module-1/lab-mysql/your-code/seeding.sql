...
INSERT INTO `Cars` VALUES (0,'3K096I98581DHSNUP','Volkswagen','Tiguan','2019','Blue'),(1,'ZM8G7BEUQZ97IH46V','Peugeot','Rifter','2019','Red'),(2,'RKXVNNIHLVVZOUB4M','Ford','Fusion','2018','White'),(3,'HKNDGS7CU31E9Z7JW','Toyota','RAV4','2018','Silver'),(4,'DAM41UDN3CHU2WVF6','Volvo','V60','2019','Gray'),(5,'DAM41UDN3CHU2WVF6','Volvo','V60 Cross CCountry','2019','Gray');
...
INSERT INTO `Customers` VALUES (10001,'Pablo Picasso','+34 636 17 63 82','','Paseo de la Chopera, 14 - Madrid','Madrid','Spain','28045',3),(20001,'Abraham Lincoln','+1 305 907 7086','','120 SW 8th St - Miami','Florida','USA','33130',0),(30001,'Napoléon Bonaparte','+33 1 79 75 40 00','','40 Rue du Colisée - Paris','Île-de-France','France','75008',2);
...
INSERT INTO `Salespersons` VALUES (1,'Petey Cruiser','Madrid'),(2,'Anna Sthesia','BCN'),(3,'Paul Molive','Berlin'),(4,'Gail Forcewind','Paris'),(5,'Paige Turner','Mimia'),(6,'Bob Frapples','Mexico City'),(7,'Walter Melon','Amsterdam'),(8,'Shonda Leer','São Paulo');
...
-- Dump completed on 2019-04-09 20:21:58
